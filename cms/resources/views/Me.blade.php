...
<div id="main-wrapper">
    ...
    <section class="single-page-title">
        <a href="#"><img class="meimage" src="{{ $zann->imageMe }}" alt="Image"></a>
        <!--/img/me.jpg-->
        <div class="container text-center">
            ...
            <section class="about-text ptb-100">
                ...
                <div class="container">
                    <div class="row">
                        <div class="text">
                            <p>{{ $zann->descriptionMe }}</p><br>
                            <a href="/me/edit/{{ $zann->id}}" class="btn btn-zan-noshadow btn-radiuszan"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
                        </div>
