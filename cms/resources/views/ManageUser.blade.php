                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <table class="table table-lol">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $i++ }}</td>
                                    <td><img src="{{asset('storage/'.$a->imageUser)}}" class="user-img"> </td>
                                    <td>{{$a->roles}}</td>
                                    <td>{{$a->name}}</td>
                                    <td>{{$a->email}}</td>
                                    <td>{{$a->created_at}}</td>
                        ...
                        <a href="manageuser/add" class="btn btn-zan-noshadow btn-radiuszan"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add User</a>
                        <a href="/cetakuser_pdf" class="btn btn-zan-noshadow btn-radiuszan" target="_blank"><i class="fa fa-print" aria-hidden="true"></i> Print PDF</a>
                    </div>
                </div>
                <!-- /.row -->
