                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <table class="table table-lol">
                            ...
                            <tbody>
                                @php $i=1 @endphp @foreach($bodykits as $a)
                                <tr>
                                    <td>{{$i++}}</td>
                                    <td><img src="{{asset('storage/'.$a->imageurl)}}" class="product-img"> </td>
                                    <td>{{$a->title}}</td>
                                    <td>{{$a->created_at}}</td>
                                    <td>
                        ...
                        <a href="manage/add" class="btn btn-zan-noshadow btn-radiuszan"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Product</a>
                        <a href="/cetak_pdf" class="btn btn-zan-noshadow btn-radiuszan" target="_blank"><i class="fa fa-print" aria-hidden="true"></i> Print PDF</a>
                    </div>
                </div>
                <!-- /.row -->
